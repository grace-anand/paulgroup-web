      ...
      <div className="container-custom mx-auto relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
            We're here to assist you with your real estate and construction needs. Reach out to us for inquiries, assistance, or to schedule a consultation.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a href="tel:+919042666555" className="px-6 py-2 bg-primary text-white rounded-full transition hover:bg-opacity-90 flex items-center">
            ...
            <a href="mailto:enquiry@rubybuilderschennai.com" className="px-6 py-2 bg-gray-100 text-gray-700 rounded-full transition hover:bg-gray-200 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="mr-2">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              Email Us
            </a>
            <a href="https://api.whatsapp.com/send?phone=+919042666555&text=Hi,%20I'm%20interested%20in%20Ruby%20Builders%20Project.%20Please%20get%20in%20touch%20with%20me." target="_blank" rel="noopener noreferrer" className="px-6 py-2 bg-green-500 text-white rounded-full transition hover:bg-green-600 flex items-center">
