      ...
      <div className="container-custom mx-auto relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col items-center md:items-start text-center md:text-left mb-12 md:mb-0">
            <h2 className="text-6xl md:text-7xl font-black text-primary mb-2 italic">
              PAUL
            </h2>
            <h2 className="text-6xl md:text-7xl font-black text-primary italic">
              Builders
            </h2>
            <div className="mt-6">
